...
<div class="container-fluid">
   ...
   <div class="container boiler-container-section">
      <form class="" action="{{URL::to('/generate-quotation/step2/'.$uniqid)}}" method="post">
      @csrf
      @method('PUT')
      ...
      <div class="row mt-3">
        <div class="col-lg-6">
          <a href="{{URL::to('/generate-quotation/step1/'.$lead->lead_id.'/'.$uniqid)}}" class="float-leftc btn btn-primary" style="background-color: #d50527;border-color: #d50527;"><i class="fa fa-arrow-left" aria-hidden="true"></i> Previous</a>
        </div>
         <div class="col-lg-6">
