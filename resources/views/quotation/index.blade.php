...
@section('css')
<style>
img.browse-image-modification {
    height: 40px;
    border-radius: 4px;
}
span.browse-option-modification {
    position: absolute;
    top: 13px;
    left: 26px;
    cursor: pointer;
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <ul class="nav nav-tabs" id="myTab" role="tablist">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" id="oil-tab" data-toggle="tab" href="#oil" role="tab" aria-controls="contact" aria-selected="false">Oil</a>
                     </li>
                  ...
                  <div class="tab-content" id="myTabContent">
                     ...
                     <div class="tab-pane fade show active" id="regular" role="tabpanel" aria-labelledby="regular-tab">
                      ...
                      <form id="boilerRegularForm" method="post" enctype="multipart/form-data">
                       ...
                       <div class="row">
                         ...
                         <div class="col-md-3">
                           <input type="file" class="form-control" id="boiler_regular_image" accept="image/jpeg" name="image" required>
                         </div>

                         <div class="col-md-2">

                           <input type="text" class="form-control" placeholder="Boiler Company" id="boiler_regular_company" required>
                         </div>
                         <div class="col-md-2">
                           <input type="text" class="form-control" placeholder="Boiler Pack" id="boiler_regular_pack" required>
                         </div>
                         <div class="col-md-2">
                           <input type="text" class="form-control" placeholder="Boiler Price" id="boiler_regular_price" required>
                         </div>
                         <div class="col-md-2">
                           <input type="text" class="form-control" placeholder="Boiler Warranty" id="boiler_regular_warranty" required>
                         </div>
                       ...
                       <div class="tab-pane fade show active" id="regular" role="tabpanel" aria-labelledby="regular-tab">
                        ...
                        <form onsubmit="return boilerSystem();" id="boilerSystemForm">
                         <div class="row">
                           ...
                           <div class="col-md-3">
                             <input type="file" class="form-control" id="boiler_system_image" accept="image/jpeg" name="image" required>
                           </div>

                           <div class="col-md-2">
                             <input type="text" class="form-control" placeholder="Boiler Company" id="boiler_system_company" required>
                           </div>
                           <div class="col-md-2">
                             <input type="text" class="form-control" placeholder="Boiler Pack" id="boiler_system_pack" required>
                           </div>
                           <div class="col-md-2">
                             <input type="text" class="form-control" placeholder="Boiler Price" id="boiler_system_price" required>
                           </div>
                           <div class="col-md-2">
                             <input type="text" class="form-control" placeholder="Boiler Warranty" id="boiler_system_warranty" required>
                           </div>
                     ...
                     <div class="tab-pane fade" id="combi" role="tabpanel" aria-labelledby="combi-tab">
                       ...
                       <form onsubmit="return boilerCombi();" id="boilerCombiForm">
                        <div class="row">
                          <div class="col-md-3">
                            <input type="file" class="form-control" id="boiler_combi_image" accept="image/jpeg" name="image" required>
                          </div>
                          <div class="col-md-2">
                            <input type="text" class="form-control" placeholder="Boiler Company" id="boiler_combi_company" required>
                          </div>
                          <div class="col-md-2">
                            <input type="text" class="form-control" placeholder="Boiler Pack" id="boiler_combi_pack" required>
                          </div>
                          <div class="col-md-2">
                            <input type="text" class="form-control" placeholder="Boiler Price" id="boiler_combi_price" required>
                          </div>
                          <div class="col-md-2">
                            <input type="text" class="form-control" placeholder="Boiler Warranty" id="boiler_combi_warranty" required>
                          </div>
                     ...
                     <div class="tab-pane fade" id="electric" role="tabpanel" aria-labelledby="electric-tab">
                       ...
                       <form onsubmit="return boilerElectric();" id="boilerElectricForm">
                        <div class="row">
                          <div class="col-md-3">
                            <input type="file" class="form-control" id="boiler_electric_image" accept="image/jpeg" name="image" required>
                          </div>
                          <div class="col-md-2">
                            <input type="text" class="form-control" placeholder="Boiler Company" id="boiler_electric_company" required>
                          </div>
                          <div class="col-md-2">
                            <input type="text" class="form-control" placeholder="Boiler Pack" id="boiler_electric_pack" required>
                          </div>
                          <div class="col-md-2">
                            <input type="text" class="form-control" placeholder="Boiler Price" id="boiler_electric_price" required>
                          </div>
                          <div class="col-md-2">
                            <input type="text" class="form-control" placeholder="Boiler Warranty" id="boiler_electric_warranty" required>
                          </div>
                    ...
                    <br>
                    <!-- SHOW BOILER EELECTRIC DATA -->
                    <div id="fetchBoilerOil">
                       <center><img src="{{URL::to('public/myloader.gif')}}" alt="loader" height="50px"></center>
                    </div>
                    <!-- SHOW BOILER EELECTRIC DATA -->
                    <br>
                    <center><img src="{{URL::to('public/myloader.gif')}}" alt="loader" height="50px" id="boilerOilFormLoader" style="display:none"></center>
                    <form onsubmit="return boilerOil();" id="boilerOilForm">
                       <div class="row">
                         <div class="col-md-3">
                            <input type="file" class="form-control" id="boiler_oil_image" accept="image/jpeg" name="image" required>
                         </div>
                          <div class="col-md-2">
                             <input type="text" class="form-control" placeholder="Boiler Company1" id="boiler_oil_company" required>
                          </div>
                          <div class="col-md-2">
                             <input type="text" class="form-control" placeholder="Boiler Pack1" id="boiler_oil_pack" required>
                          </div>
                          <div class="col-md-2">
                             <input type="text" class="form-control" placeholder="Boiler Price" id="boiler_oil_price" required>
                          </div>
                          <div class="col-md-2">
                             <input type="text" class="form-control" placeholder="Boiler Warranty" id="boiler_oil_warranty" required>
                          </div>
                ...
                <div class="col-md-12">
                  ...
                  <form onsubmit="return boilersControls();" id="boilersControlsForm" method="post">
                   <div class="row">
                     <!-- <input type="text" name="" value=""> -->
                     <div class="col-md-8">
                       <input type="text" class="form-control" placeholder="Boiler Pack" id="boiler_controls" required>
                     </div>
                     <div class="col-md-3">
                       <input type="text" class="form-control" placeholder="Boiler Price" id="boiler_controls_price" required>
                     </div>
                     <div class="col-md-1">
                       <button type="submit" name="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                     </div>
                ...
                <div class="col-md-12">
                  ...
                  <form onsubmit="return boltsOn();" id="boltsOnForm" method="post">
                   <div class="row">
                     <!-- <input type="text" name="" value=""> -->
                     <div class="col-md-6">
                       <input type="text" class="form-control" placeholder="Bolts on name" id="bolts_on_name" required>
                     </div>
                     <div class="col-md-5">
                       <input type="text" class="form-control" placeholder="Bolts on value" id="bolts_on_value" required>
                     </div>
                     <div class="col-md-1">
                       <button type="submit" name="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                     </div>
                ...
                <div class="col-md-12">
                  ...
                  <form onsubmit="return currentBoilerType();" id="currentBoilerTypeForm" method="post">
                   <div class="row">
                     <!-- <input type="text" name="" value=""> -->
                     <div class="col-md-11">
                       <input type="text" class="form-control" placeholder="Current Boiler Type" id="current_boiler_type" required>
                     </div>
                     <div class="col-md-1">
                       <button type="submit" name="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                     </div>
                ...
                <div class="col-md-12">
                  ...
                  <form onsubmit="return currentBoilerLocation();" id="currentBoilerLocationForm" method="post">
                   <div class="row">
                     <!-- <input type="text" name="" value=""> -->
                     <div class="col-md-11">
                       <input type="text" class="form-control" placeholder="Current Boiler Type" id="current_boiler_location" required>
                     </div>
                     <div class="col-md-1">
                       <button type="submit" name="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                     </div>
                ...
                <div class="col-md-12">
                  ...
                  <form onsubmit="return currentBoilerFlue();" id="currentBoilerFlueForm" method="post">
                   <div class="row">
                     <!-- <input type="text" name="" value=""> -->
                     <div class="col-md-11">
                       <input type="text" class="form-control" placeholder="Current Boiler Flue" id="current_boiler_flue" required>
                     </div>
                     <div class="col-md-1">
                       <button type="submit" name="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                     </div>
                ...
                <div class="col-md-12">
                  ...
                  <form onsubmit="return existingShower();" id="existingShowerForm" method="post">
                   <div class="row">
                     <!-- <input type="text" name="" value=""> -->
                     <div class="col-md-11">
                       <input type="text" class="form-control" placeholder="Current Boiler Flue" id="existing_shower" required>
                     </div>
                     <div class="col-md-1">
                       <button type="submit" name="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                     </div>
                ...
                <div class="col-md-12">
                  ...
                  <form onsubmit="return newFuelType();" id="newfuelTypeForm" method="post">
                   <div class="row">
                     <!-- <input type="text" name="" value=""> -->
                     <div class="col-md-6">
                       <input type="text" class="form-control" placeholder="New Fuel Type" id="newfuel_type" required>
                     </div>
                     <div class="col-md-5">
                       <input type="text" class="form-control" placeholder="New Fuel Type Price" id="newfuel_type_price" required>
                     </div>
                     <div class="col-md-1">
                       <button type="submit" name="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                     </div>
                ...
                <div class="col-md-12">
                  ...
                  <form onsubmit="return NewBoilerType();" id="NewBoilerTypeForm" method="post">
                   <div class="row">
                     <!-- <input type="text" name="" value=""> -->
                     <div class="col-md-6">
                       <input type="text" class="form-control" placeholder="New Boiler Type" id="newboiler_type" required>
                     </div>
                     <div class="col-md-5">
                       <input type="text" class="form-control" placeholder="New Boiler Type Price" id="newboiler_type_price" required>
                     </div>
                     <div class="col-md-1">
                       <button type="submit" name="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                     </div>
                ...
                <div class="col-md-12">
                  ...
                  <form onsubmit="return newFlueType();" id="newFlueTypeForm" method="post">
                   <div class="row">
                     <!-- <input type="text" name="" value=""> -->
                     <div class="col-md-6">
                       <input type="text" class="form-control" placeholder="New Flue Type" id="new_flue_type" required>
                     </div>
                     <div class="col-md-5">
                       <input type="text" class="form-control" placeholder="New Flue Type Price" id="new_flue_type_price" required>
                     </div>
                     <div class="col-md-1">
                       <button type="submit" name="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                     </div>
                ...
                <div class="col-md-12">
                  ...
                  <form onsubmit="return newFlueLocation();" id="newFlueLocationForm" method="post">
                   <div class="row">
                     <!-- <input type="text" name="" value=""> -->
                     <div class="col-md-11">
                       <input type="text" class="form-control" placeholder="New Flue Location" id="new_flue_location" required>
                     </div>
                     <div class="col-md-1">
                       <button type="submit" name="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                     </div>
                ...
                <div class="col-md-12">
                  ...
                  <form onsubmit="return condensateTermination();" id="condensateTerminationForm" method="post">
                   <div class="row">
                     <!-- <input type="text" name="" value=""> -->
                     <div class="col-md-11">
                       <input type="text" class="form-control" placeholder="Condencate Termination" id="condence_termination" required>
                     </div>
                     <div class="col-md-1">
                       <button type="submit" name="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                     </div>
                ...
                <div class="col-md-12">
                  ...
                  <form onsubmit="return newControls();" id="newControlsForm" method="post">
                   <div class="row">
                     <!-- <input type="text" name="" value=""> -->
                     <div class="col-md-6">
                       <input type="text" class="form-control" placeholder="New Controls" id="newcontrols" required>
                     </div>
                     <div class="col-md-5">
                       <input type="text" class="form-control" placeholder="New Controls Price" id="newcontrols_price" required>
                     </div>
                     <div class="col-md-1">
                       <button type="submit" name="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                     </div>
                ...
                <div class="col-md-12">
                  ...
                  <form onsubmit="return removals();" id="removalsForm" method="post">
                   <div class="row">
                     <!-- <input type="text" name="" value=""> -->
                     <div class="col-md-11">
                       <input type="text" class="form-control" placeholder="Removals" id="removal" required>
                     </div>
                     <div class="col-md-1">
                       <button type="submit" name="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                     </div>
                  ...
                  <br>
                   ...
                   <form onsubmit="return cupboardnalt();" id="cupboardnaltForm" method="post">
                    <div class="row">
                      <!-- <input type="text" name="" value=""> -->
                      <div class="col-md-6">
                        <input type="text" class="form-control" placeholder="Removals" id="cupboardnalt_value" required>
                      </div>

                      <div class="col-md-5">
                        <input type="text" class="form-control" placeholder="Removals Price" id="cupboardnalt_value_price" required>
                      </div>
                  ...
                  <br>
                   ...
                   <form onsubmit="return chemicalSystemTreatment();" id="chemicalSystemTreatmentForm" method="post">
                    <div class="row">
                      <!-- <input type="text" name="" value=""> -->
                      <div class="col-md-7">
                        <input type="text" class="form-control" placeholder="Chemical System Treatment" id="chemicalsystemtreatment_value" required>
                      </div>
                      <div class="col-md-4">
                        <input type="text" class="form-control" placeholder="Chemical System Treatment Price" id="chemicalsystemtreatment_price" required>
                      </div>
                      <div class="col-md-1">
                        <button type="submit" name="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                      </div>
                  ...
                  <br>
                   ...
                   <form onsubmit="return gasSupplyRequirements();" id="gasSupplyRequirementsForm" method="post">
                    <div class="row">
                      <!-- <input type="text" name="" value=""> -->
                      <div class="col-md-11">
                        <input type="text" class="form-control" placeholder="Gas Supply Requirements" id="gassupplyrequirements_value" required>
                      </div>
                      <div class="col-md-1">
                        <button type="submit" name="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                      </div>
                  ...
                  <br>
                   ...
                   <form onsubmit="return electricalWorkRequired();" id="electricalWorkRequiredForm" method="post">
                    <div class="row">
                      <!-- <input type="text" name="" value=""> -->
                      <div class="col-md-6">
                        <input type="text" class="form-control" placeholder="Electrical Work Required" id="electricalworkrequired_value" required>
                      </div>
                      <div class="col-md-5">
                        <input type="text" class="form-control" placeholder="Electrical Work Required Price" id="electricalworkrequired_value_price" required>
                      </div>
                      <div class="col-md-1">
                        <button type="submit" name="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                      </div>
                  ...
                  <br>
                   ...
                   <form onsubmit="return gasSupplyLength();" id="gasSupplyLengthForm" method="post">
                    <div class="row">
                      <!-- <input type="text" name="" value=""> -->
                      <div class="col-md-6">
                        <input type="text" class="form-control" placeholder="Gas Supply Length" id="gassupplylength_value" required>
                      </div>
                      <div class="col-md-5">
                        <input type="text" class="form-control" placeholder="Gas Supply Length Price" id="gassupplylengthprice_value" required>
                      </div>
                      <div class="col-md-1">
                        <button type="submit" name="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                      </div>
                  ...
                  <br>
                   ...
                   <form onsubmit="return acm();" id="acmForm" method="post">
                    <div class="row">
                      <!-- <input type="text" name="" value=""> -->
                      <div class="col-md-11">
                        <input type="text" class="form-control" placeholder="Asbestos Containing Materials (ACM) Identified" id="acm_value" required>
                      </div>
                      <div class="col-md-1">
                        <button type="submit" name="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                      </div>
                  ...
                  <br>
                   ...
                   <form onsubmit="return parReq();" id="parReqForm" method="post">
                    <div class="row">
                      <!-- <input type="text" name="" value=""> -->
                      <div class="col-md-11">
                        <input type="text" class="form-control" placeholder="Parking Requirements" id="parreq_value" required>
                      </div>
                      <div class="col-md-1">
                        <button type="submit" name="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                      </div>
                  ...
                  <br>
                   ...
                   <form onsubmit="return flueKit();" id="flueKitForm" method="post">
                    <div class="row">
                      <!-- <input type="text" name="" value=""> -->
                      <div class="col-md-6">
                        <input type="text" class="form-control" placeholder="Flue Kit" id="fluekit_value" required>
                      </div>
                      <div class="col-md-5">
                        <input type="text" class="form-control" placeholder="Flue Kit Price" id="fluekit_value_price" required>
                      </div>
                      <div class="col-md-1">
                        <button type="submit" name="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                      </div>
      ...
      <div class="row">
        <!-- <div class="row"> -->
         <div class="col-md-12">
           <div class="card">
             <div class="card-header">
                <label><h3>60/100mm Flue Components</h3></label>
             </div>
             <div class="card-body">
                <div class="col-md-12">
                  <br>
                  ...
                  <br>
                   ...
                   <form onsubmit="return flueKitDetails();" id="flueKitDetailsForm" method="post">
                    <div class="row">
                      <!-- <input type="text" name="" value=""> -->
                      <div class="col-md-8">
                        <input type="text" class="form-control" placeholder="60/100mm Flue Components" id="fluekitdetails_value" required>
                      </div>
                      <div class="col-md-3">
                        <input type="text" class="form-control" placeholder="Price" id="fluekitdetails_price" required>
                      </div>
                      <div class="col-md-1">
                        <button type="submit" name="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                      </div>
                  ...
                  <br>
                   ...
                   <form onsubmit="return magneticSystemFilter();" id="magneticSystemFilterForm" method="post">
                    <div class="row">
                      <!-- <input type="text" name="" value=""> -->
                      <div class="col-md-6">
                        <input type="text" class="form-control" placeholder="Magnetic System Filter" id="magneticsystemfilter_value" required>
                      </div>
                      <div class="col-md-5">
                        <input type="text" class="form-control" placeholder="Magnetic System Filter Price" id="magneticsystemfilter_value_price" required>
                      </div>
                      <div class="col-md-1">
                        <button type="submit" name="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                      </div>
                  ...
                  <br>
                   <form onsubmit="return ventedCylinderDimensions();" id="ventedCylinderDimensionsForm" method="post">
                    <div class="row">
                      <!-- <input type="text" name="" value=""> -->
                      <div class="col-md-6">
                        <input type="text" class="form-control" placeholder="Vented Cylinder Dimensions" id="ventedcylinderdimensions_value" required>
                      </div>
                      <div class="col-md-5">
                        <input type="text" class="form-control" placeholder="Vented Cylinder Dimensions" id="ventedcylinderdimensions_price_value" required>
                      </div>
                      <div class="col-md-1">
                        <button type="submit" name="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                      </div>
           ...
           <div class="card">
             ...
             <div class="card-body">
                <div class="col-md-12">
                  ...
                  <br>
                   <form onsubmit="return height();" id="heightForm" method="post">
                    <div class="row">
                      <div class="col-md-11">
                        <input type="text" class="form-control" placeholder="Height" id="height_value" required>
                      </div>
                      <div class="col-md-1">
                        <button type="submit" name="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                      </div>
           ...
           <div class="card">
             ...
             <div class="card-body">
                <div class="col-md-12">
                  ...
                  <br>
                   <form onsubmit="return width();" id="widthForm" method="post">
                    <div class="row">
                      <div class="col-md-11">
                        <input type="text" class="form-control" placeholder="Width" id="width_value" required>
                      </div>
                      <div class="col-md-1">
                        <button type="submit" name="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                      </div>
...
<script type="text/javascript">
  ...
  fetchBoilerOil();
  function fetchBoilerOil(){
    $('#fetchBoilerOil').load('{{URL::to("_fetchBoilerOil")}}');
...
$('#boilerRegularForm').submit(function(e){
      ...
      formdata.append('company', $('#boiler_regular_company').val());
...
<script type="text/javascript">
  function boilerSystem(){
    ...
    formdata.append('company', $('#boiler_system_company').val());
...
<script type="text/javascript">
  function boilerCombi(){
    ...
    formdata.append('company', $('#boiler_combi_company').val());
...
<script type="text/javascript">
  function boilerElectric(){
    ...
    formdata.append('company', $('#boiler_electric_company').val());
...
<script type="text/javascript">
  function newFuelType(){
    ...
    var newfuel_type_price= $('#newfuel_type_price').val();
...
<script type="text/javascript">
  function NewBoilerType(){
    ...
    var newboiler_type_price= $('#newboiler_type_price').val();
    $.ajax({
      type:'post',
...
<script type="text/javascript">
  function newFlueType(){
    ...
    var new_flue_type_price= $('#new_flue_type_price').val();
    $.ajax({
      type:'post',
      url:'{{URL::to("/newflue")}}',
      data:{
...
<script type="text/javascript">
  function newControls(){
    ...
    var newcontrols_price= $('#newcontrols_price').val();
...
<script type="text/javascript">
  function cupboardnalt(){
    ...
    var cupboardnalt_value_price= $('#cupboardnalt_value_price').val();
    ...
    $.ajax({
      ...
      data:{
        "_token": "{{ csrf_token() }}",
        name:cupboardnalt,
        price:cupboardnalt_value_price
      },
      success:function(data){
        // alert(data);
        if(data=='Success'){
...
<script type="text/javascript">
  function chemicalSystemTreatment(){
    ...
    var chemicalsystemtreatment_price= $('#chemicalsystemtreatment_price').val();
    ...
    $.ajax({
      ...
      data:{
        ...
        price:chemicalsystemtreatment_price
      },
      success:function(data){
        // alert(data);
        if(data=='Success'){
...
<script type="text/javascript">
  function electricalWorkRequired(){
    ...
    var fetchElectricalWorkRequiredPrice= $('#electricalworkrequired_value_price').val();
    ...
    $.ajax({
      ...
      data:{
        ...
        price:fetchElectricalWorkRequiredPrice
      },
      success:function(data){
        // alert(data);
        if(data=='Success'){
...
<script type="text/javascript">
  function gasSupplyLength(){
    ...
    var gassupplylengthprice_value= $('#gassupplylengthprice_value').val();
    ...
    $.ajax({
      ...
      data:{
        ...
        price:gassupplylengthprice_value,
      },
      success:function(data){
        // alert(data);
        if(data=='Success'){
...
<script type="text/javascript">
  function flueKit(){
    ...
    var fluekit_value_price= $('#fluekit_value_price').val();
...
<script type="text/javascript">
  function magneticSystemFilter(){
    ...
    var magneticsystemfilter_value_price= $('#magneticsystemfilter_value_price').val();
    $.ajax({
      type:'post',
      ...
      data:{
        ...
        price:magneticsystemfilter_value_price
      },
      success:function(data){
        // alert(data);
        if(data=='Success'){
...
<script type="text/javascript">
  function ventedCylinderDimensions(){
    ...
    var ventedcylinderdimensions_price_value= $('#ventedcylinderdimensions_price_value').val();
    ...
    $.ajax({
      ...
      data:{
        ...
        price:ventedcylinderdimensions_price_value
      },
      success:function(data){
        // alert(data);
        if(data=='Success'){
...
function fetchHeight(){
  $('#fetchHeight').load('{{URL::to("_fetchHeight")}}');
}
</script>
...
<script type="text/javascript">
  function heightDelete(id){
    $.ajax({
      type:'get',
      url:'{{URL::to("/heightset/")}}'+'/'+id,
      success:function(data){
        // alert(data);
        if(data=='Success'){
          fetchHeight();
...
fetchWidth();
function fetchWidth(){
  $('#fetchWidth').load('{{URL::to("_fetchWidth")}}');
}
</script>

<script type="text/javascript">
  function width(){
    var width_value= $('#width_value').val();
    $.ajax({
      type:'post',
      url:'{{URL::to("/widthset")}}',
      data:{
...
<script type="text/javascript">
  function widthDelete(id){
    $.ajax({
      type:'get',
      url:'{{URL::to("/widthset/")}}'+'/'+id,
      success:function(data){
        // alert(data);
        if(data=='Success'){
          fetchWidth();
...
<script type="text/javascript">
  ...
  function boilerOil(){
    $('#boilerOilFormLoader').show();
    $('#boilerOilForm').hide();

    var formdata = new FormData();
    formdata.append('_token', "{{ csrf_token() }}");
    formdata.append('file', document.getElementById('boiler_oil_image').files[0]);
    formdata.append('boilertype', $('#boiler_oil_pack').val());
    formdata.append('price', $('#boiler_oil_price').val());
    formdata.append('company', $('#boiler_oil_company').val());

    formdata.append('boilerchoise_id', 5);
    formdata.append('warranty', $('#boiler_oil_warranty').val());

    $.ajax({
        url: "{{url('boilerchoiceoil')}}",
        data: formdata,
        type: 'post',
        contentType: false,
        processData: false,
        ...
        {
          if(data=='Success'){
            $('#boilerOilForm').trigger("reset");
            $('#boilerOilFormLoader').hide();
            $('#boilerOilForm').show();
            fetchBoilerOil();
          }else{
            alert('Failed')
...
<script type="text/javascript">
function boilerOilSystemDelete(data){
  alert(data);
  $.ajax({
    type:'get',
    url:'{{URL::to("/boilerchoiceoil/delete/")}}'+'/'+data,
    success:function(data){
      // alert(data);
      console.log(data);
      if(data=='Success'){
