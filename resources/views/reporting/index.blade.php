...
<div class="container-fluid">
   <div class="row">
               ...
               <div class="input-group">
                  ...
                  <div class="col-md-12">
                     <div class="mainDateRange">
                        ...
                        <div class="dateMain">
                           <div class="range">
                              <div id="reportrange" class="pull-right" style="background: #fff;cursor: pointer;padding: 5px 10px;border: 1px solid #ccc;width: 250px;margin-right: 18px;">
      ...
      <div class="col-lg-4">
         <div class="card">
            <div class="card-body">
               <div id="chartContainer4" style="height: 215px; width: 100%;"></div>
							 <div id="chartContainer5" style="height: 215px; width: 100%;"></div>
            </div>
         </div>
      </div>
