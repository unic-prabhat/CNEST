...
<div class="topbar">
    ...
    <nav class="navbar-custom">
        <ul class="list-unstyled topbar-nav float-right mb-0">
            ...
            <li class="dropdown notification-list">
                ...
                <div class="sub-menu-top dropdown-menu-right dropdown-lg pt-0">
                    ...
                    <h6 class="dropdown-item-text font-15 m-0 py-3 bg-primary text-white d-flex justify-content-between align-items-center">
                        Notifications <span class="badge badge-light badge-pill">{{count($arrcount)}}</span>
                    </h6>
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown" href="#" role="button"
                    ...
                    <img src="https://s3.amazonaws.com/37assets/svn/765-default-avatar.png" alt="profile-user" class="rounded-circle" id="uperprofileimgjk" />
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  ...
                  $uid=Auth::user()->id;
                  @endphp
                    <a class="dropdown-item" href="{{URL::to('saleesuserprofileud/'.$uid)}}"><i class="dripicons-user text-muted mr-2"></i> Profile</a>
        ...
        <ul class="list-unstyled topbar-nav mb-0">
            ...
            <a href="{{URL::to('salesuser')}}"><img src="{{asset('public/logo.png')}}" alt="logo-large" class="logo-lg logo-dark"></a>
            </li>
        </ul>
    </nav>
    <!-- end navbar-->
