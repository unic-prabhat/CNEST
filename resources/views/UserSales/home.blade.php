                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8 align-self-center text-right">
                                            <div class="ml-2">
                                                ...
                                                <h3 class="mt-0 mb-1 font-weight-semibold">{{count(App\Lead::where('user_id',$uid)->where('created_at','>=',date('Y-m-d'))->where('user_id',$uid)->get())}}</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="progress mt-2" style="height:3px;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8 col-8 align-self-center text-right">
                                            <div class="ml-2">
                                                ...
                                                <h3 class="mt-0 mb-1 font-weight-semibold">{{count(App\Lead::where('user_id',$uid)->where(
