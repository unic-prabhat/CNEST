   ...
   <div class="row parent col-lg-12" id="">
      ...
      <div class="child">
         ...
         <div class="form-group">
            ...
            <input type="text" value="{{$data->oe_description}}" class="form-control input-decorate" required />
      ...
      <div class="child">
         ...
         <div class="form-group">
            ...
            <input type="text" value="{{$data->oe_quantity}}" class="form-control input-decorate" required />
      ...
      <div class="child">
         ...
         <div class="form-group">
            ...
            <input type="text" value="{{$data->oe_price}}" class="form-control input-decorate" required />
