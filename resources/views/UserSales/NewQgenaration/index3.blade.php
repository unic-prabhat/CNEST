...
<div class="container-fluid">
   ...
   <div class="container boiler-container-section">
      ...
      <form class="" action="{{URL::to('/generate-quotation/salesuser/step3/'.$uniqid)}}" method="post">
      ...
      <div class="row mt-3">
        ...
        <div class="col-lg-6">
          ...
          <a href="{{URL::to('/generate-quotation/salesuser/step2/'.$lead->lead_id.'/'.$uniqid)}}" class="float-leftc btn btn-primary" style="background-color: #d50527;border-color: #d50527;"><i class="fa fa-arrow-left" aria-hidden="true"></i> Previous</a>
...
<script type="text/javascript">
  addOnPrice()
  function addOnPrice(){
    $('#addonprice').load('{{URL::to("/salesusershowaddonprice/".$uniqid)}}');
  }
</script>
