   ...
   <div class="col-sm-12">
      <div class="page-title-box">
         <div class="float-right">
            <ol class="breadcrumb">
               <li class="breadcrumb-item active">Sales User</li>
         ...
         <div class="card-body">
            <div class="row">
               <ul class="col float-right container-filter categories-filter mb-0" id="filter">
                  <!--- GENERATE QOTE --->
                  <li><a href="{{URL::to('/generate-quotation/salesuser/'.$lead->id)}}" class="categories btn btn-blue btn-square waves-effect waves-light" data-filter=".branding">Generate Quote</a></li>
      ...
      <div class="card">
         <div class="card-body">
            <div class="media mb-3">
               <!--<img src="../assets/images/users/user-4.jpg" class="mr-3 thumb-xl align-self-center rounded-circle" alt="...">-->
               ...
               <table class="table table-striped mb-0 table my-table">
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <a href="javascript:void(0);">{{$lead->user->name}}</a>
                        </td>
                     </tr>
                     <tr>
                        <td>
                        ...
                        <td>
                           <a href="javascript:void(0);">{{$lead->leadsource}}</a>
                        </td>
                     </tr>
                     <tr>
                        <td>
                        ...
                        <td>
                           <div style="position:relative">
                              <a href="#" id="address1" data-type="address" data-pk="{{$lead->id}}" data-placeholder="Your comments here..." data-title="Enter comments" class="editable editable-click">{{$lead->address}}, {{$lead->town}}, {{$lead->country}}, {{$lead->postcode}}
                              </a>
                     ...
                     <td><a href="javascript:void(0);">{{date('F d,Y',strtotime($lead->created_at))}}</a></td>
                  </tbody>
               </table>
            </div>
         </div>
             ...
             <div class="tab-pane p-3 active" id="all" role="tabpanel">
                     ...
                     <table class="table">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td> <a href="{{URL::to('/generate-quotation/salesuser/step1/'.$lead->id.'/'.$qtn->main_uniqid)}}" target="_blank"> <i class="far fa-edit"></i> </a> </td>
               ...
               <script type="text/javascript">
                  ...
                  function _showALl(){
                    ...
                    $('#_fetchAllData').load('{{URL::to("/_salesuserfetchAll/".$lead->id)}}')
               ...
               <div class="tab-pane p-3" id="home" role="tabpanel">
                  ...
                  <script type="text/javascript">
                     ...
                     function _showNotes(){
                       ...
                       $('#_showNotes').load('{{URL::to("/_salesuserfetchNotes/".$lead->id)}}')
             ...
             <!-- ==========================================CALL========================================== -->
               ...
               <script type="text/javascript">
                  ...
                  function _showCall(){
                    ...
                    $('#_showCall').load('{{URL::to("/_salesuserfetchCall/".$lead->id)}}')
               ...
               <div class="tab-pane p-3" id="settings" role="tabpanel">
                  ...
                  <script type="text/javascript">
                     ...
                     function _showMeetings(){
                       ...
                       $('#_showMeetings').load('{{URL::to("/_salesuserfetchMeeting/".$lead->id)}}')
               ...
               <div class="tab-pane p-3" id="attachment" role="tabpanel">
                  ...
                  <script type="text/javascript">
                     ...
                     function _showAttachment(){
                       ...
                       $('#_showAttachment').load('{{URL::to("/_salesuserfetchAttachments/".$lead->id)}}')
         ...
         <div class="modal-body">
            <form style="width: 400px;margin: auto;" method="post" action="{{route('task.store')}}">
               ...
               <input type="hidden" name="lead_id" value="{{$lead->id}}"/>
                <input type="hidden" name="userAssign_id" value="{{auth()->user()->id}}"/>
               <div class="row">
                  <div class="col-md-12">
                     <div class="form-group">
