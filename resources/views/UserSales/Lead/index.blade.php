            ...
            <div class="row">
               ...
               <div class="col-8 align-self-center text-right">
                  <div class="ml-2">
                     ...
                     $uid=Auth::user()->id;
                     @endphp
                     <h3 class="mt-0 mb-1 font-weight-semibold"><a href="{{URL::to('saleslead')}}">{{count(App\Lead::where('user_id',$uid)->get())}}</a></h3>
                  </div>
               </div>
            </div>
            ...
            <div class="row">
               ...
               <div class="col-8 align-self-center text-right">
                  <div class="ml-2">
                     ...
                     <h3 class="mt-0 mb-1 font-weight-semibold">{{count(App\Lead::where('user_id',$uid)->where('created_at','>=',date('Y-m-d'))->get())}}</h3>
                  </div>
               </div>
            </div>
            <div class="progress mt-2" style="height:3px;">
            ...
            <div class="row">
               ...
               <div class="col-8 align-self-center text-right">
                  <div class="ml-2">
                     ...
                     <h3 class="mt-0 mb-1 font-weight-semibold d-inline-block">{{count(App\Lead::where('user_id',$uid)->whereBetween('created_at', [Carbon\Carbon::now()->startOfWeek(),
               ...
               <div class="col-sm-8 col-8 align-self-center text-right">
                  <div class="ml-2">
                     ...
                     <h3 class="mt-0 mb-1 font-weight-semibold">
                        {{count(App\Lead::where('user_id',$uid)->where('created_at', '>=', Carbon\Carbon::now()->firstOfMonth()->toDateTimeString())->get())}}
                     </h3>
                  </div>
               </div>
            </div>
      ...
      <div class="card-body">
         ...
         <div class="moreFilterDash mb-4">
            ...
            <div>
               ...
               <!-- <button type="button" class="btn btn-gradient-primary
                  waves-effect waves-light float-right mb-3" data-toggle="modal" data-target="#myModal">
               ...
               <div class="modal" id="myModal">
                  <div class="modal-dialog-lg" style="width: 100%;padding-left: 15%;padding-right: 15%;padding-top: 5%;">
                     <div class="modal-content">
                        <div class="modal-header custom-cls-d"><button type="button" class="close" data-dismiss="modal">×</button></div>
                        <!-- Modal body -->
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             ...
                                             <input type="text" class="form-control" id="landlinenumber" name="landlinenumber" required>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
            ...
            <div id="getTable">
               <table class="table" id="datatable">
                  ...
                  <tbody>
                     ...
                     @foreach($search->where('user_id',$uid) as $key=>$val)
                     <tr>
                        ...
                        <td><a href="{{route('lead.show',[$val->id])}}">{{Auth::user()->name}}</a></td>
                        <td> <a href="{{route('lead.show',[$val->id])}}">
                           @if($val->status == 'Hot Lead')
                           <span class="badge badge-md badge-soft-danger ">{{$val->status}}</span>
                     ...
                     @else
                     @if(count($leads) > 0)
                     @foreach($leads->where('user_id',$uid) as $todo)
                     <tr>
                        <td><a href="{{URL::to('saleslead/'.$todo->id)}}">{{$todo->firstname}}</a></td>
                        <td><a href="{{URL::to('saleslead/'.$todo->id)}}">{{$todo->email}}</a></td>
                        <td><a href="{{URL::to('saleslead/'.$todo->id)}}">{{$todo->mobilenumber}}</a></td>
                        <td><a href="{{URL::to('saleslead/'.$todo->id)}}">{{$todo->address}},{{ $todo->town}},{{$todo->country}}</a></td>
                        <td><a href="{{URL::to('saleslead/'.$todo->id)}}">{{$todo->leadsource}}</a></td>
                        <td><a href="{{URL::to('saleslead/'.$todo->id)}}">
            ...
            <form action="{{route('lead.store')}}" method="post" id="leadForm">
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="form-group">
                        <label for="leadsource">Lead Source</label>
                        <select class="custom-select" id="leadsource" name="leadsource">
                           <option selected="">Select</option>
                           <option value="PPC">PPC</option>
                           <option value="Organic Boiler">Organic Boiler</option>
                           <option value="Guide">Guide</option>
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        <label for="PhoneNo">Lead assign to</label>
                        <select class="custom-select" id="leadassignto" name="user_id">
                           <option selected="">Select</option>
                           @foreach(App\User::all() as $user)
                           <option value="{{$user->id}}">{{$user->name}}</option>
                           @endforeach
