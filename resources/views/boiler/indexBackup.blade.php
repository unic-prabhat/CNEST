                     ...
                     <div class="col-lg-12 ss">
                        ...
                        <div class="row show_next mt-5" id="choice_get_control" name="">
                           <div class="col-lg-4 rr">
                              ...
                              <select class="form-control" name="first_boiler_controls">
                           ...
                           <div class="col-lg-4 rr">
                              ...
                              <select class="form-control" name="second_boiler_controls">
                                <option value="" selected="selected" class="gf_placeholder">Please select</option>
                                @foreach(App\BoilerControls::all() as $bc)
                                <option value="{{$bc->price}}">{{$bc->pack}}</option>
                                @endforeach
                           ...
                           <div class="col-lg-4 rr">
                              ...
                              <select class="form-control" name="third_boiler_controls" onchange="all_check_bolts()">
                                <option value="" selected="selected" class="gf_placeholder">Please select</option>
                                @foreach(App\BoilerControls::all() as $bc)
                                <option value="{{$bc->price}}">{{$bc->pack}}</option>
                                @endforeach
                        ...
                        <div class="row mt-4 show_next" id="bolts">
                           <div class="col-lg-12 bolts">
                              ...
                              <ul>
                                ...
                                <li><input type="checkbox" name="bolt_ons" class="form-control check" name=boltson[] value="{{$bto->value}}"><label>{{$bto->name}}</label>

                                <input type="number" class="mynumshow" name="boltsonnum[]"></li>
                        ...
                        <div class="row mt-4">
                           <div class="col-lg-6 rr">
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-8">
                                    <input class="form-control" type="text" id="example-email-input" value="{{$lead->firstname}}" disabled><input type="hidden" name="cus_firstname" value="{{$lead->firstname}}">
                                 </div>
                              </div>
                              <div class="form-group row">
                                 <label for="example-tel-input" class="col-sm-4 col-form-label text-left">Sure Name</label>
                                 <div class="col-sm-8">
                                    <input class="form-control" type="text" name="cus_surname" value="{{$lead->surname}}" disabled><input type="hidden" name="cus_surname" value="{{$lead->surname}}">
                                 </div>
                              </div>
                              <div class="form-group row">
                                 <label for="example-password-input" class="col-sm-4 col-form-label text-left">Email</label>
                                 <div class="col-sm-8">
                                    <input class="form-control" type="email" name="email" value="{{$lead->email}}">
                                 </div>
                              </div>
                           </div>
                           <div class="col-lg-6 rr">
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-8">
                                    <input class="form-control" type="text" id="example-email-input" value="{{$lead->address}}" disabled><input type="hidden" name="cus_installation_address" value="{{$lead->address}}">
                                 </div>
                              </div>
                              <div class="form-group row">
                                 <label for="example-tel-input" class="col-sm-4 col-form-label text-left">Street Address</label>
                                 <div class="col-sm-8">
                                    <input class="form-control" type="text" value="{{$lead->town}}" disabled><input type="hidden" name="cus_street_address" value="{{$lead->town}}">
                                 </div>
                              </div>
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-8">
                                    <input class="form-control" type="text" value="{{$lead->postcode}}" disabled><input type="hidden" name="cus_postal_code" value="{{$lead->postcode}}">
                                 </div>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-6">
                        <div class="form-group">
                           ...
                           <select class="form-control" name="supply_change" name="gas_supply_requirements">
                              <option value="" selected="selected" class="gf_placeholder">Please select</option>
                    ...
                    <div class="col-lg-12">
                     ...
                     <div class="col-lg-6">
                        <div class="form-group">
                           ...
                           <select class="form-control">
                              <option value="" selected="selected" class="gf_placeholder">Please select</option>
                              <option value="1 - 2 Days|0">1 Day Engineer Labour</option>
                              <option value="2 - 3 Days|0">2 Days Engineer Labour</option>
                              <option value="3 - 4 Days|0">3 Days Engineer Labour</option>
                              <option value="4 - 5 Days|0">4 Days Engineer Labour</option>
                              <option value="5 -6 Days|0">5 Days Engineer Labour</option>
                              <option value="6 -7 Days|0">6 Days Engineer Labour</option>
                              <option value="7 -8 Days|0">7 Days Engineer Labour</option>
                              <option value="8 - 9 Days|0">8 Days Engineer Labour</option>
                              <option value="9 -10 Days|0">9 Days Engineer Labour</option>
                              <option value="10 - 11 Days|0">10 Days Engineer Labour</option>
                           </select>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="main_row_class">
                     <div class="row">
                        <div class="col-lg-4">
                           <div class="form-group">
                              ...
                              <input class="form-control" name="boiler_1_guide_price" type="text" id="guideone" value="3300"/>
                           </div>
                        </div>
                        <div class="col-lg-4">
                           <div class="form-group">
                              <label>Boiler 2 Guide Price</label>
                              <input class="form-control" type="text" name="boiler_2_guide_price" id="guidetwo" value="3500"/>
                           </div>
                        </div>
                        <div class="col-lg-4">
                           <div class="form-group">
                              <label>Boiler 3 Guide Price</label>
                              <input class="form-control" type="text" name="boiler_3_guide_price" id="guidethree" value="2000"/>
                           </div>
                        </div>
                     </div>
                     <div class="row">
                     ...
                     <div class="row">
                        <div class="col-lg-4">
                           <div class="form-group">
                              <label>Boiler 1 Amend*</label>
                              <input class="form-control" type="text" id="answerone"/>
                           </div>
                        </div>
                        <div class="col-lg-4">
                           <div class="form-group">
                              <label>Boiler 2 Amend*</label>
                              <input class="form-control" type="text" id="answertwo"/>
                           </div>
                        </div>
                        <div class="col-lg-4">
                           <div class="form-group">
                              <label>Boiler 3 Amend*</label>
                              <input class="form-control" type="text" id="answerthree"/>
                           </div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-lg-12">
                           <div class="form-group">
                              ...
                              <input class="form-control" name="deposit_required" type="text"/>
                           </div>
                        </div>
                     </div>
                     <div class="row">
